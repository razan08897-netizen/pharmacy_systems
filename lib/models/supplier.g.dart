...
void _supplierSerialize(
  ...
  writer.writeDouble(offsets[0], object.currentBalance);
...
Supplier _supplierDeserialize(
  ...
  object.currentBalance = reader.readDouble(offsets[0]);
  object.id = id;
...
extension SupplierQueryWhere on QueryBuilder<Supplier, Supplier, QWhereClause> {
  ...
  QueryBuilder<Supplier, Supplier, QAfterWhereClause> nameEqualTo(String name) {
    return QueryBuilder.apply(this, (query) {
...
extension SupplierQueryFilter
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> currentBalanceEqualTo(
    double value, {
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> currentBalanceBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> initialBalanceEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> initialBalanceBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension SupplierQuerySortBy on QueryBuilder<Supplier, Supplier, QSortBy> {
  QueryBuilder<Supplier, Supplier, QAfterSortBy> sortByCurrentBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentBalance', Sort.asc);
    });
  }

  QueryBuilder<Supplier, Supplier, QAfterSortBy> sortByCurrentBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentBalance', Sort.desc);
    });
  }

  QueryBuilder<Supplier, Supplier, QAfterSortBy> sortByInitialBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'initialBalance', Sort.asc);
    });
  }

  QueryBuilder<Supplier, Supplier, QAfterSortBy> sortByInitialBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SupplierQuerySortThenBy
  ...
  QueryBuilder<Supplier, Supplier, QAfterSortBy> thenByCurrentBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentBalance', Sort.asc);
    });
  }

  QueryBuilder<Supplier, Supplier, QAfterSortBy> thenByCurrentBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentBalance', Sort.desc);
    });
  }
  ...
  QueryBuilder<Supplier, Supplier, QAfterSortBy> thenByInitialBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'initialBalance', Sort.asc);
    });
  }

  QueryBuilder<Supplier, Supplier, QAfterSortBy> thenByInitialBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'initialBalance', Sort.desc);
    });
  }
...
extension SupplierQueryWhereDistinct
  ...
  QueryBuilder<Supplier, Supplier, QDistinct> distinctByCurrentBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'currentBalance');
    });
  }

  QueryBuilder<Supplier, Supplier, QDistinct> distinctByInitialBalance() {
    return QueryBuilder.apply(this, (query) {
...
extension SupplierQueryProperty
  ...
  QueryBuilder<Supplier, double, QQueryOperations> currentBalanceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'currentBalance');
    });
  }

  QueryBuilder<Supplier, double, QQueryOperations> initialBalanceProperty() {
    return QueryBuilder.apply(this, (query) {
