...
extension CustomerQueryFilter
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> currentBalanceEqualTo(
    double value, {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> currentBalanceBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> initialBalanceEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> initialBalanceBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CustomerQuerySortBy on QueryBuilder<Customer, Customer, QSortBy> {
  QueryBuilder<Customer, Customer, QAfterSortBy> sortByCurrentBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentBalance', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> sortByCurrentBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentBalance', Sort.desc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> sortByInitialBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'initialBalance', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> sortByInitialBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQuerySortThenBy
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> thenByCurrentBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentBalance', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> thenByCurrentBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentBalance', Sort.desc);
    });
  }
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> thenByInitialBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'initialBalance', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> thenByInitialBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'initialBalance', Sort.desc);
    });
  }
...
extension CustomerQueryWhereDistinct
  ...
  QueryBuilder<Customer, Customer, QDistinct> distinctByCurrentBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'currentBalance');
    });
  }

  QueryBuilder<Customer, Customer, QDistinct> distinctByInitialBalance() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQueryProperty
  ...
  QueryBuilder<Customer, double, QQueryOperations> initialBalanceProperty() {
    return QueryBuilder.apply(this, (query) {
